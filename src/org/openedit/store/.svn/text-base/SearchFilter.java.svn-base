...
public class SearchFilter
{
	...
	protected XmlFile fieldSavedCategoryFilters; // User specific. Temporary hidden ones
	...
	public List listFilters()
	{
		...
		{
			for (Iterator iterator = getSavedFilters().getElements().iterator(); iterator
					.hasNext();)
			{
		...
		{
			for (Iterator iterator = getSavedCategoryFilters().getElements()
		...
		{
			for (Iterator iterator = getExcludeCategories().iterator(); iterator
					.hasNext();)
			{
	...
	public void clearSavedFilters(String inId)
	{
		if (getSavedFilters() != null)
		{
			...
			for (Iterator iter = getSavedFilters().getElements().iterator(); iter
					.hasNext();)
			{
	...
	public List listAllFilters()
	{
		...
		if (getUser() != null)
		{
			...
			for (Iterator iterator = allsettings.keySet().iterator(); iterator
					.hasNext();)
			{
				String key = (String) iterator.next();
				if (key.startsWith("excluderecords:")
						|| key.startsWith("limitrecords:"))
				{
	...
	public String toFilter(boolean inUsesSecurity)
	{
		...
		if (inUsesSecurity)
		{
			...
			if (getUser() != null)
			{
				...
				for (Iterator iterator = getUser().getGroups().iterator(); iterator
						.hasNext();)
				{
