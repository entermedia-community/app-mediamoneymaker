...
//	}
	...
	public SearchFilter saveUserCategoryFilter(WebPageRequest inReq, List inCategories, User inUser, String inCatalogId)
			throws Exception {
...
//	}
	...
	public SearchFilter getSearchFilter(WebPageRequest inReq,
			boolean inIncludeSavedFilter, boolean inSelected, String inCatalogId)
			throws OpenEditException {
		...
		if (inUser == null) 
		{
			//TODO: We should return a negative filter or something
			return null;
		}
		...
		if (!settings.isExist()) 
		{
			String altpath = "/" + inCatalogId
					+ "/data/userfilters/defaultcategories.xml";
...
//	public XmlFile loadSystemWideFilters(String level) throws OpenEditException {
